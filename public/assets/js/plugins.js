    ...
    var uiElements = function(){
        ...
        var uiOwlCarousel = function(){
            ...
            if($(".owl-carousel").length > 0){
                $(".owl-carousel").owlCarousel({pagination: false, mouseDrag: false, touchDrag: true, slideSpeed: 300, paginationSpeed: 400, singleItem: true, navigation: false, autoPlay: true});
            }
